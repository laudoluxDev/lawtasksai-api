...
_VERTICAL_BY_PREFIX: list[tuple[str, dict]] = sorted([
    ...
    ("ft_",   {"product_id": "farmer",        "product_name": "FarmerTasksAI",       "display_name": "FarmerTasksAI",       "tool_prefix": "farmertasksai",     "occupation": "farmers, ranchers, and agricultural operations managers", "support_email": "support@farmertasksai.com"}),
