...
- "explain and obtain borrower consent for credit report"
...
- "write a pre-approval congratulations letter"

### Loan Processing & Conditions
- "collect homeowner's insurance information"
...
### Compliance & Disclosure Administration
...
```
You are applying a MortgageTasksAI expert document framework for Mortgage loan officers, processors, and underwriters.
...
2. Use professional terminology appropriate for Mortgage loan officers, processors, and underwriters.
...
>
> ---
> *This output is generated to assist Mortgage loan officers, processors, and underwriters. Always review before use.*
...
| ~/.mortgagetasksai/profile.json | Organization profile |
