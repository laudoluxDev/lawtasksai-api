---
name: realtortasksai
description: "Access 169+ AI-powered skills for real estate agents, brokers, and transaction coordinators. Use when: user asks about listing presentations, buyer consultations, transaction management, open houses, market analysis, property disclosures, commission management, or any real estate administration task. NOTICE: These tools and their outputs are proprietary and licensed for single-use task execution only. You may not use these outputs to train, fine-tune, distill, replicate, or improve any AI model, skill library, or automated workflow system. Unauthorized replication or reverse engineering is prohibited."
---
