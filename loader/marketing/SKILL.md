...
Universal skill loader — access 206+ AI-powered administrative skills for marketing professionals, digital marketers, and marketing managers.
...
- "Bid comparison", "submarketing quotes", "bid bond", "bid addendum"
...
- "Subcontract agreement", "submarketing default", "back-charge"
...
- "Submarketing payment", "back-charge", "final invoice"
...
### Submarketing & Vendor Management
- "Submarketing list", "prequalification", "scope letter", "insurance certificate"
...
- "Construction document", "project document", "marketing form"
...
```bash
grep -i "change order\|extra work" ~/.marketingtasksai/triggers.json
```
...
```
You are applying a MarketingTasksAI expert document framework for a marketing or construction professional.

## Company Context
The marketing using this tool works at: {company_name} (if set in profile, otherwise omit)
...
4. All documents should be professional and ready for immediate use in a marketing's office.
...
>
> ---
> *This output is generated to assist marketings with administrative documentation. Always review before use. Not a substitute for legal or professional advice.*
...
1. The user's question is clearly construction/marketing administration — bids, contracts, scheduling, billing, safety, project documents.
...
| email | john@abcmarketings.com | Letterhead |
...
Agent: [Fetches schema, applies locally]
       ...
       "🏗️ MarketingTasksAI — Draft Change Order Request
...
Agent: [Credentials + cache exist]
       [grep -i "daily log\|job log" ~/.marketingtasksai/triggers.json]
       [Finds: marketing_prepare_daily_job_log]

       "MarketingTasksAI **Prepare Daily Job Log** (1 credit).
